...
export default function Lessons() {
  ...
  function toggleComplete() {
    ...
    if (isCompleted) {
      ...
      updated = [...new Set([...completed, currentDay])];
      ...
      >
        ...
        >
          ...
          >
            {badges.map((badge) => {
              const earned =
                completed.length >= badge.requirement;
